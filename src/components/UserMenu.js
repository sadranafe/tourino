        ...
        <div>
            <DropdownMenu dir = 'rtl'>
                <DropdownMenuTrigger asChild>
                    <button className = 'text-green-600 border border-green-400 p-2 px-3 rounded-lg text-[15px] outline-none flex justify-between items-center gap-1'>
                        <UserIcon width = {18}/>
                        <span>{user?.mobile}</span>
                    </button>
                </DropdownMenuTrigger>
                    
                <DropdownMenuContent className = 'rounded-xl shadow-[0_5px_10px_rgba(0,0,0,0.03)] bg-white/60 backdrop-blur-md p-2 mx-3'>
                    <DropdownMenuItem className = 'p-0'>
                        <Link href = '/dashboard' className = 'px-2 py-1.5 gap-2 w-full flex justify-start items-center rounded-lg border border-transparent hover:border-white/55 hover:bg-gradient-to-r hover:from-neutral-100/60 hover:to-white/50 hover:shadow-[0_5px_10px_rgba(0,0,0,0.03)] transition-all'>
