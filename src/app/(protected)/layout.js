...
const ProtectedLayout = ({ children }) => {
    ...
    return(
        <div className = "flex justify-between max-[700px]:flex-wrap gap-5 p-5 px-10 max-lg:px-5 xl:w-[1280px] mx-auto">
            <div className = "sticky max-[400px]:text-xs bg-white max-[700px]:w-full max-[700px]:flex max-[700px]:justify-center max-[700px]:items-center max-[700px]:shadow-lg max-[700px]:shadow-neutral-50 top-5 border border-dashed rounded-xl overflow-hidden max-h-fit w-[200px]">
